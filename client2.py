...
class FileTransferApp:
    ...
    def setup_main_window(self):
        ...
        self.send_image = send_image  # Keep a reference to prevent garbage collection
        ...
        self.receive_image = receive_image  # Keep a reference to prevent garbage collection
